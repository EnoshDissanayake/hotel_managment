 ...
 * @author Acer
 */
public class ProductRegistation extends javax.swing.JFrame {
     GRN grn;

    /**
     * Creates new form ProductRegistation
     */
    public ProductRegistation() {
        initComponents();
        loadBrands();
        loadcategory();
        loadProducts();
    }
      public ProductRegistation(GRN grn) {
        initComponents();
        loadBrands();
        loadcategory();
        loadProducts();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jTextField1.getText().isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Product is already exists", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductRegistation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductRegistation().setVisible(true);
            }
        });
    }
